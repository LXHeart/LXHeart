...
public class TuLingRobot {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="ed61cbf7892b7264eaf6e2e69d3e93c6";
    ...
    public static void getRequest2(){
        ...
        Map params = new HashMap();//请求参数
            params.put("dtype","xml");//返回的数据格式，json或xml，默认json
    ...
    public static void main(String[] args) {
    	String a = "{\"reason\":\"成功的返回\",\"result\":{\"code\":100000,\"text\":\"你陪我玩我就好啦\"},\"error_code\":0}";
    	JSONObject json = JSONObject.fromObject(a);
    	json = JSONObject.fromObject(json.get("result"));
