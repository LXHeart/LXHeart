...
public class ReadExecl {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<List<String>> list = poi.read("C:\\Users\\Administrator.SC-201706091102\\Desktop\\软件\\工作簿1.xlsx");//C:\Users\Administrator.SC-201706091102\Desktop\hongyundoc\02.需求管理\需求说明书
        if (list != null) {
